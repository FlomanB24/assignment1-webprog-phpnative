                ...
                <div class="col-md-5">
                    <form action="" method="post">
                        <div class="mb-3" >
                            ...
                            <input type="text" name="patient" id="patient" autocomplete="off" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="datebox" name="entry" id="entry" autocomplete="off">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-4">
                            <button type="submit" name="submit"  class="btn btn-success">Add Medical Record</button>
                        </div>
                    </form>
                </div>
            </div>
